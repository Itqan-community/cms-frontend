...
import type { TafsirDetails } from '../../models/tafsirs.models';
import { TafsirsService } from '../../services/tafsirs.service';
import { TafsirFormComponent } from './tafsir-form.component';

describe('TafsirFormComponent template controls', () => {
  let tafsirsServiceMock: jasmine.SpyObj<TafsirsService>;
  ...
  const detail: TafsirDetails = {
    id: 1,
    slug: 'existing-tafsir',
    name_ar: 'اسم التفسير',
    name_en: 'Tafsir name',
  ...
  function configure(routeParams: Record<string, string>): void {
    tafsirsServiceMock = jasmine.createSpyObj<TafsirsService>('TafsirsService', [
      'getDetail',
      'create',
      'patch',
    ]);
    tafsirsServiceMock.getDetail.and.returnValue(of(detail));
    ...
    TestBed.configureTestingModule({
      imports: [TafsirFormComponent],
      providers: [
        { provide: ActivatedRoute, useValue: { snapshot: { params: routeParams } } },
        { provide: Router, useValue: jasmine.createSpyObj<Router>('Router', ['navigate']) },
        { provide: TafsirsService, useValue: tafsirsServiceMock },
        {
    ...
    TestBed.overrideComponent(TafsirFormComponent, { set: { template: '' } });
  }

  it('requires a template when creating', () => {
    configure({});
    const fixture = TestBed.createComponent(TafsirFormComponent);
  ...
  it('disables both controls in edit mode', () => {
    configure({ slug: 'existing-tafsir' });
    const fixture = TestBed.createComponent(TafsirFormComponent);
  ...
  it('omits template and mushaf_layout_id from the update payload', () => {
    configure({ slug: 'existing-tafsir' });
    tafsirsServiceMock.patch.and.returnValue(of(detail));
    const fixture = TestBed.createComponent(TafsirFormComponent);
    fixture.detectChanges();

    fixture.componentInstance.onSubmit();

    expect(tafsirsServiceMock.patch).toHaveBeenCalled();
    const body = tafsirsServiceMock.patch.calls.mostRecent().args[1];
  ...
  it('includes template and mushaf_layout_id in the create payload', () => {
    configure({});
    tafsirsServiceMock.create.and.returnValue(of(detail));
    const fixture = TestBed.createComponent(TafsirFormComponent);
    fixture.detectChanges();
    ...
    expect(tafsirsServiceMock.create).toHaveBeenCalled();
    const body = tafsirsServiceMock.create.calls.mostRecent().args[0];
