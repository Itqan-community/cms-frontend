...
/**
 * GET /portal/recitations/{slug_or_id}/recitation-tracks/ — single row shape (OpenAPI RecitationTrackOut).
 */
...
/** Paginated list response for GET /portal/recitations/…/recitation-tracks/ */
