...
/**
 * GET /portal/assets/{slug_or_id}/recitation-tracks/ — single row shape (OpenAPI RecitationTrackOut).
 */
...
/** Paginated list response for GET /portal/assets/…/recitation-tracks/ */
