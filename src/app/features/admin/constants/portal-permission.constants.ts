...
export const PORTAL_PERMISSIONS = {
  ...
  PORTAL_VIEW_MEMBERS: 'portal_view_members',
  PORTAL_INVITE_MEMBERS: 'portal_invite_members',
  PORTAL_UPDATE_MEMBERS: 'portal_update_members',
  PORTAL_DELETE_MEMBERS: 'portal_delete_members',
} as const;
