...
import { FontFilters } from '../../models/fonts.models';
import {
...
@Component({
  ...
  template: `
    <div class="font-filters">
      <div class="admin-filters-bar">
        <nz-input-group [nzPrefix]="searchIcon">
          <input
            nz-input
            type="text"
            [placeholder]="'ADMIN.FONTS.SEARCH_PLACEHOLDER' | translate"
            [ngModel]="searchValue"
        ...
        >
          ...
          <span>{{ 'ADMIN.FONTS.FILTERS.BUTTON' | translate }}</span>
        </button>
      </div>
      ...
      <nz-modal
        ...
        [nzTitle]="'ADMIN.FONTS.FILTERS.MODAL_TITLE' | translate"
        [nzWidth]="'min(560px, 92vw)'"
        nzCentered
      >
        <ng-container *nzModalContent>
          <div class="font-filters__modal-grid">
            <nz-select
              class="font-filters__select"
              [nzPlaceHolder]="'ADMIN.FONTS.FILTERS.PUBLISHER' | translate"
              nzSize="default"
              nzAllowClear
              nzShowSearch
              nzServerSearch
            ...
            <nz-select
              class="font-filters__select"
              [nzPlaceHolder]="'ADMIN.FONTS.FILTERS.LICENSE' | translate"
              nzSize="default"
              nzAllowClear
            ...
            <nz-select
              class="font-filters__select"
              [nzPlaceHolder]="'ADMIN.FONTS.FILTERS.LANGUAGE' | translate"
              nzSize="default"
              nzAllowClear
            ...
            <nz-select
              class="font-filters__select"
              [nzPlaceHolder]="'ADMIN.FONTS.FILTERS.IS_EXTERNAL' | translate"
              nzSize="default"
              nzAllowClear
            ...
            >
              <nz-option
                [nzValue]="true"
                [nzLabel]="'ADMIN.FONTS.FILTERS.TYPE_EXTERNAL' | translate"
              ></nz-option>
              <nz-option
                [nzValue]="false"
                [nzLabel]="'ADMIN.FONTS.FILTERS.TYPE_INTERNAL' | translate"
              ></nz-option>
            </nz-select>
          </div>
        </ng-container>
        <ng-container *nzModalFooter>
          <div class="font-filters__modal-footer">
            <button nz-button nzType="default" nzSize="default" (click)="clearAdvancedFilters()">
              {{ 'ADMIN.FONTS.FILTERS.CLEAR' | translate }}
            </button>
            <button nz-button nzType="primary" nzSize="default" (click)="closeFiltersModal()">
              {{ 'ADMIN.FONTS.FILTERS.DONE' | translate }}
            </button>
          </div>
        </ng-container>
      </nz-modal>
  ...
  `,
  styleUrl: './font-filters.component.less',
})
export class FontFiltersComponent implements OnInit {
  @Output() filtersChange = new EventEmitter<Partial<FontFilters>>();
  initialFilters = input<Partial<FontFilters>>({});
  ...
  private currentFilters: Partial<FontFilters> = {};
  ...
  private hydrateFromFilters(f: Partial<FontFilters>): void {
