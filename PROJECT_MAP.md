...
| `/admin/access-requests` | (lazy routes)                  | `accessRequestsAccessGuard`      | Asset access requests list/accept/reject + auto-acceptance toggle via `/portal/access-requests/`    |
...
| `access-requests/` | Asset access requests | `AccessRequestOut`                  | List/accept/reject + auto-acceptance toggle via `/portal/access-requests/`; detail drawer; permission-gated actions |
...
access requests (`/portal/access-requests/` — list, detail, accept, reject, auto-acceptance toggle),
mushafs (pages/surahs/ayahs/words), usage analytics
