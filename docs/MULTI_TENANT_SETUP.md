...
This is a proof-of-concept implementation for multi-tenant functionality where publishers can host the CMS on their own domains with filtered content.
...
4. Test:
   ...
   - Visit `http://customorg.localhost:4200` → Publisher view (subdomain pattern, filtered by publisher ID 1)
